...
Twitter.prototype.search = function (q, params, callback) {
  ...
  self.get('/search/tweets.json', utils.merge({q: q}, params), callback);
};
...
Twitter.prototype.stream = function(method, params, callback) {
  ...
  stream.destroyForce = function () {
    if (stream.twitter) {
      stream.twitter.removeAllListeners('end');
      stream.twitter.removeAllListeners('close');
      stream.twitter = null;
    }
